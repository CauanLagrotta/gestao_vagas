package br.com.lagrotta.gestao_vagas.modules.candidate.controllers;

import br.com.lagrotta.gestao_vagas.modules.candidate.dto.ProfileCandidateResponseDTO;
import br.com.lagrotta.gestao_vagas.modules.candidate.entity.CandidateEntity;
import br.com.lagrotta.gestao_vagas.modules.candidate.useCases.ApplyJobCandidateUseCase;
import br.com.lagrotta.gestao_vagas.modules.candidate.useCases.CreateCandidateUseCase;
import br.com.lagrotta.gestao_vagas.modules.candidate.useCases.ListAllJobsByFilterUseCase;
import br.com.lagrotta.gestao_vagas.modules.candidate.useCases.ProfileCandidateUseCase;
...
public class CandidateController {
  ...
  @GetMapping("/job")
  @PreAuthorize("hasRole('CANDIDATE')")
  @Operation(summary = "Listagem de vagas disponível para o candidato", description = "Essa função é responsável por listar as vagas disponíveis, baseada no filtro")
  @ApiResponses({
      @ApiResponse(responseCode = "200", content = {
          @Content(
